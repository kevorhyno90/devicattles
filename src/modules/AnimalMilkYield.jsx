    ...
    <section className="milk-premium">
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(150px, 1fr))', gap: 12, marginBottom: 20 }}>
        ...
        <div className="card" style={{ padding: 16, background: '#f0fdf4' }}>
          <div style={{ fontSize: 11, color: 'var(--text-secondary)', marginBottom: 4 }}>Total Milk Produced</div>
        ...
        <div className="card" style={{ padding: 16, background: '#e0f2fe' }}>
          <div style={{ fontSize: 11, color: 'var(--text-secondary)', marginBottom: 4 }}>Milk Given to Calf</div>
        ...
        <div className="card" style={{ padding: 16, background: '#dbeafe' }}>
          <div style={{ fontSize: 11, color: 'var(--text-secondary)', marginBottom: 4 }}>Milk Consumed</div>
        ...
        <div className="card" style={{ padding: 16, background: '#e0f2fe' }}>
          <div style={{ fontSize: 11, color: 'var(--text-secondary)', marginBottom: 4 }}>Milk Sold</div>
        ...
        <div className="card" style={{ padding: 16, background: '#d1fae5' }}>
          <div style={{ fontSize: 11, color: 'var(--text-secondary)', marginBottom: 4 }}>Total Revenue (Sold Milk)</div>
        ...
        <div className="card" style={{ padding: 16, background: unsoldMilk > 0 ? '#fef3c7' : '#eff6ff' }}>
          <div style={{ fontSize: 11, color: 'var(--text-secondary)', marginBottom: 4 }}>Unsold Milk</div>
        ...
        <div className="card" style={{ padding: 16, background: '#eff6ff' }}>
          <div style={{ fontSize: 11, color: 'var(--text-secondary)', marginBottom: 4 }}>Avg Daily Total Milk</div>
        ...
        <div className="card" style={{ padding: 16, background: '#fef3c7' }}>
          <div style={{ fontSize: 11, color: 'var(--text-secondary)', marginBottom: 4 }}>Avg Fat %</div>
        ...
        <div className="card" style={{ padding: 16, background: '#dbeafe' }}>
          <div style={{ fontSize: 11, color: 'var(--text-secondary)', marginBottom: 4 }}>Avg Protein %</div>
        ...
        {avgLactose > 0 && (
          <div className="card" style={{ padding: 16, background: '#f3e8ff' }}>
            <div style={{ fontSize: 11, color: 'var(--text-secondary)', marginBottom: 4 }}>Avg Lactose %</div>
        ...
        {avgSNF > 0 && (
          <div className="card" style={{ padding: 16, background: '#e0e7ff' }}>
            <div style={{ fontSize: 11, color: 'var(--text-secondary)', marginBottom: 4 }}>Avg SNF %</div>
        ...
        {avgTS > 0 && (
          <div className="card" style={{ padding: 16, background: '#fce7f3' }}>
            <div style={{ fontSize: 11, color: 'var(--text-secondary)', marginBottom: 4 }}>Avg Total Solids %</div>
        ...
        {avgSCC > 0 && (
          <div className="card" style={{ padding: 16, background: avgSCC < 200000 ? '#d1fae5' : avgSCC < 400000 ? '#fef3c7' : '#fee2e2' }}>
            <div style={{ fontSize: 11, color: 'var(--text-secondary)', marginBottom: 4 }}>Avg SCC</div>
        ...
        {avgTemp > 0 && (
          <div className="card" style={{ padding: 16, background: '#fef3c7' }}>
            <div style={{ fontSize: 11, color: 'var(--text-secondary)', marginBottom: 4 }}>Avg Temp °C</div>
        ...
        {avgPh > 0 && (
          <div className="card" style={{ padding: 16, background: '#e0f2fe' }}>
            <div style={{ fontSize: 11, color: 'var(--text-secondary)', marginBottom: 4 }}>Avg pH</div>
        ...
        {avgDuration > 0 && (
          <div className="card" style={{ padding: 16, background: '#f0fdf4' }}>
            <div style={{ fontSize: 11, color: 'var(--text-secondary)', marginBottom: 4 }}>Avg Duration</div>
        ...
        <div className="card" style={{ padding: 16, background: 'var(--bg-secondary)' }}>
          <div style={{ fontSize: 11, color: 'var(--text-secondary)', marginBottom: 4 }}>14-Day Yield Trend</div>
              ...
              <table style={{ width: '100%', fontSize: 13, borderCollapse: 'collapse' }}>
                ...
                <tbody>
                  {Object.entries(phase2MilkInsights.yearTotals).sort((a, b) => a[0] < b[0] ? 1 : -1).map(([year, vals]) => (
                    <tr key={year} style={{ background: 'var(--bg-elevated)' }}>
                  ...
                  {Object.keys(phase2MilkInsights.yearTotals).length === 0 && (
                    <tr>
                      <td colSpan={5} style={{ padding: '8px', border: '1px solid #eee', color: 'var(--text-secondary)' }}>No yearly totals available yet.</td>
                    </tr>
                  )}
                </tbody>
              </table>
      ...
      {showAddForm && (
        <div className="card" style={{ padding: 20, marginBottom: 20, background: 'var(--bg-secondary)', border: '2px solid #059669', boxShadow: '0 14px 32px rgba(5, 150, 105, 0.12)' }}>
          <h4 style={{ marginTop: 0, color: '#059669' }}>
            {editingId ? '✏️ Edit Milk Production Record' : '➕ Add Comprehensive Milk Production Record'}
          </h4>
          
          {/* Basic Information */}
          <h5 style={{ marginTop: 16, marginBottom: 12, color: 'var(--text-secondary)' }}>📋 Basic Information</h5>
          ...
          <h5 style={{ marginTop: 16, marginBottom: 12, color: 'var(--text-secondary)' }}>🧮 Milk Allocation & Loss</h5>
          ...
          <h5 style={{ marginTop: 16, marginBottom: 12, color: 'var(--text-secondary)' }}>🧪 Milk Quality Parameters</h5>
          ...
          {/* Sales Information */}
          <h5 style={{ marginTop: 16, marginBottom: 12, color: 'var(--text-secondary)' }}>💰 Sales Information</h5>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 12 }}>
            <div>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: 16, marginBottom: 12 }}>
            <h5 style={{ margin: 0, color: 'var(--text-secondary)' }}>🐄 Milking Details</h5>
          ...
          {showAdvanced && (
            <>
              <h5 style={{ marginTop: 16, marginBottom: 12, color: 'var(--text-secondary)' }}>🌤️ Environmental & Health Factors</h5>
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: 12 }}>
                <div>
              ...
              <h5 style={{ marginTop: 16, marginBottom: 12, color: 'var(--text-secondary)' }}>⚠️ Special Conditions</h5>
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 12 }}>
          ...
          <div className="card" style={{ padding: 20 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(140px, 1fr))', gap: 12 }}>
              {Object.entries(qualityDist).map(([grade, count]) => (
                <div key={grade} style={{ padding: 12, background: 'var(--bg-secondary)', borderRadius: 6, border: '1px solid #e5e7eb' }}>
                  <div style={{ fontSize: 12, color: 'var(--text-secondary)', marginBottom: 4 }}>{grade}</div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))', gap: 12 }}>
              {Object.entries(sessionDist).map(([sess, liters]) => (
                <div key={sess} style={{ padding: 16, background: '#e0f2fe', borderRadius: 8 }}>
                  <div style={{ fontSize: 13, color: 'var(--text-secondary)', marginBottom: 6 }}>{sess}</div>
                    ...
                    <div key={aId} style={{ padding: 16, background: index === 0 ? '#fef3c7' : '#f9fafb', borderRadius: 8, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                        ...
                        <div>
                          ...
                          <div style={{ fontSize: 13, color: 'var(--text-secondary)' }}>{animal?.breed}</div>
                        </div>
                      </div>
                      <div style={{ textAlign: 'right' }}>
                        <div style={{ fontSize: 22, fontWeight: 'bold', color: '#059669' }}>{data.total.toFixed(1)} L</div>
                        <div style={{ fontSize: 12, color: 'var(--text-secondary)' }}>{avgPerSession.toFixed(1)} L avg/session</div>
                      </div>
                    </div>
                  )
                })}
            ...
            <div className="card" style={{ padding: 20 }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 16 }}>
                <div style={{ padding: 16, background: avgSCC < 200000 ? '#d1fae5' : avgSCC < 400000 ? '#fef3c7' : '#fee2e2', borderRadius: 8 }}>
                  <div style={{ fontSize: 13, color: 'var(--text-secondary)', marginBottom: 6 }}>Overall Herd SCC</div>
                ...
                <div style={{ padding: 16, background: avgFat >= 3.5 ? '#d1fae5' : '#fef3c7', borderRadius: 8 }}>
                  <div style={{ fontSize: 13, color: 'var(--text-secondary)', marginBottom: 6 }}>Fat Content</div>
                ...
                <div style={{ padding: 16, background: avgProtein >= 3.0 ? '#d1fae5' : '#fef3c7', borderRadius: 8 }}>
                  <div style={{ fontSize: 13, color: 'var(--text-secondary)', marginBottom: 6 }}>Protein Content</div>
        ...
        <div className="card" style={{ padding: 20 }}>
          ...
          <div style={{ display: 'grid', gap: 16 }}>
            {Object.entries(animalProduction).map(([aId, data]) => {
              ...
              const avgPerSession = data.total / data.count
              return (
                <div key={aId} className="card" style={{ padding: 16, background: 'var(--bg-secondary)' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 12 }}>
                    ...
                    <div style={{ textAlign: 'right' }}>
                      ...
                      <div style={{ fontSize: 12, color: 'var(--text-secondary)' }}>{data.count} sessions</div>
                    </div>
                  </div>
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(120px, 1fr))', gap: 8 }}>
                    <div style={{ padding: 8, background: 'var(--bg-elevated)', borderRadius: 4 }}>
                      <div style={{ fontSize: 11, color: 'var(--text-secondary)' }}>Avg/Session</div>
                      <div style={{ fontSize: 16, fontWeight: 600 }}>{avgPerSession.toFixed(1)} L</div>
                    </div>
                    {Object.entries(data.sessions).map(([sess, amt]) => (
                      <div key={sess} style={{ padding: 8, background: 'var(--bg-elevated)', borderRadius: 4 }}>
                        <div style={{ fontSize: 11, color: 'var(--text-secondary)' }}>{sess}</div>
        ...
        <div className="card" style={{ padding: 0, overflow: 'hidden', borderRadius: 14 }}>
          {filteredItems.length === 0 ? (
            <div style={{ padding: 40, textAlign: 'center' }}>
              ...
              <p style={{ color: 'var(--text-secondary)' }}>Add your first milk record to start tracking</p>
            </div>
          ) : (
                  ...
                  <div key={item.id} className="milk-record-row" style={{ padding: 16 }}>
                    {inlineEditId === item.id ? (
                      ...
                      <div style={{ display: 'flex', gap: 8, alignItems: 'center', marginBottom: 10, flexWrap: 'wrap' }}>
                        ...
                        <span className="badge" style={{ background: 'var(--bg-secondary)', color: 'var(--text-secondary)' }}>{item.quality}</span>
                      ...
                      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(130px, 1fr))', gap: 8, marginBottom: 6 }}>
                        <div style={{ background: '#eff6ff', borderRadius: 8, padding: 8 }}>
                          <div style={{ fontSize: 11, color: 'var(--text-secondary)' }}>Fed to calf</div>
                        ...
                        <div style={{ background: '#eef2ff', borderRadius: 8, padding: 8 }}>
                          <div style={{ fontSize: 11, color: 'var(--text-secondary)' }}>Consumed</div>
                        ...
                        <div style={{ background: '#ecfdf5', borderRadius: 8, padding: 8 }}>
                          <div style={{ fontSize: 11, color: 'var(--text-secondary)' }}>Sold</div>
                        ...
                        <div style={{ background: '#fef2f2', borderRadius: 8, padding: 8 }}>
                          <div style={{ fontSize: 11, color: 'var(--text-secondary)' }}>Spoiled</div>
