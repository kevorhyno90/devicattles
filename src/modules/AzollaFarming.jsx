    ...
    <div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 12, marginBottom: 20 }}>
        <div className="card" style={{ padding: 16, background: '#f0fdf4' }}>
          <div style={{ fontSize: 12, color: 'var(--text-secondary)', marginBottom: 4 }}>Active Ponds</div>
        ...
        <div className="card" style={{ padding: 16, background: '#eff6ff' }}>
          <div style={{ fontSize: 12, color: 'var(--text-secondary)', marginBottom: 4 }}>Total Area (m²)</div>
        ...
        <div className="card" style={{ padding: 16, background: '#fef3c7' }}>
          <div style={{ fontSize: 12, color: 'var(--text-secondary)', marginBottom: 4 }}>Weekly Yield (kg)</div>
        ...
        <div className="card" style={{ padding: 0, overflow: 'hidden' }}>
          {ponds.length === 0 ? (
            <div style={{ padding: 40, textAlign: 'center' }}>
              ...
              <p style={{ color: 'var(--text-secondary)' }}>Add your first pond to start tracking</p>
            </div>
          ) : (
