      ...
      <div ref={rootRef} style={{ width: '100%', maxWidth: 1000, maxHeight: '90vh', overflow: 'auto', background: '#fff', borderRadius: 10, padding: 18, boxShadow: '0 12px 40px rgba(2,6,23,0.3)' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '280px 1fr', gap: 16, marginTop: 12 }}>
          ...
          <div>
            ...
            <section style={{ marginBottom: 12 }}>
              <h4 style={{ margin: '4px 0', color: '#111827' }}>📊 Production</h4>
              <pre style={{ background: '#f9fafb', padding: 10 }}>{JSON.stringify(animal.production || {}, null, 2)}</pre>
            </section>

            <section style={{ marginBottom: 12 }}>
              <h4 style={{ margin: '4px 0', color: '#111827' }}>🏥 Health</h4>
              <pre style={{ background: '#f9fafb', padding: 10 }}>{JSON.stringify(animal.health || {}, null, 2)}</pre>
            </section>

            <section style={{ marginBottom: 12 }}>
              <h4 style={{ margin: '4px 0', color: '#111827' }}>📅 Events</h4>
              <pre style={{ background: '#f9fafb', padding: 10 }}>{JSON.stringify(animal.events || [], null, 2)}</pre>
            </section>

            <section style={{ marginBottom: 12 }}>
              <h4 style={{ margin: '4px 0', color: '#111827' }}>🧬 Genetics</h4>
              <pre style={{ background: '#f9fafb', padding: 10 }}>{JSON.stringify(animal.genetics || {}, null, 2)}</pre>
            </section>

            <section style={{ marginBottom: 12 }}>
              <h4 style={{ margin: '4px 0', color: '#111827' }}>💰 Financial</h4>
              <pre style={{ background: '#f9fafb', padding: 10 }}>{JSON.stringify(animal.financial || {}, null, 2)}</pre>
            </section>

            <section style={{ marginBottom: 12 }}>
              <h4 style={{ margin: '4px 0', color: '#111827' }}>📄 Documentation</h4>
              <pre style={{ background: '#f9fafb', padding: 10 }}>{JSON.stringify(animal.documentation || {}, null, 2)}</pre>
            </section>

            <section style={{ marginBottom: 12 }}>
              <h4 style={{ margin: '4px 0', color: '#111827' }}>Certifications</h4>
              <pre style={{ background: '#f9fafb', padding: 10 }}>{JSON.stringify(animal.certifications || {}, null, 2)}</pre>
            </section>

            <section style={{ marginBottom: 12 }}>
              <h4 style={{ margin: '4px 0', color: '#111827' }}>Behavior</h4>
              <pre style={{ background: '#f9fafb', padding: 10 }}>{JSON.stringify(animal.behavior || {}, null, 2)}</pre>
            </section>

            <section style={{ marginBottom: 12 }}>
              <h4 style={{ margin: '4px 0', color: '#111827' }}>Nutrition</h4>
              <pre style={{ background: '#f9fafb', padding: 10 }}>{JSON.stringify(animal.nutrition || {}, null, 2)}</pre>
            </section>

            <section style={{ marginBottom: 12 }}>
              <h4 style={{ margin: '4px 0', color: '#111827' }}>Performance</h4>
              <pre style={{ background: '#f9fafb', padding: 10 }}>{JSON.stringify(animal.performance || {}, null, 2)}</pre>
            </section>
          </div>
        </div>
